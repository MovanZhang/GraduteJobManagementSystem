			...
			<div class="topright">
				...
				<div id="navigation" class="smartmenu">
					<ul>
						...
						<li id=""><a href="government">用户登录</a>
							<ul>
	...
	<div id="body" style="background:none">
		<div class="subbanner"
			...
			<div class="subbannercontent"
				style=" width:100%; background:url(images/bolanyuan.png) top center no-repeat">
				<div class="subbody" style="padding-top:31px;">
					<div class="subbodyleft">
						<ul>
							<li class="firstli">政策信息</li>
						</ul>
						<div class="follows"></div>
					</div>
					<div class="subbodyright">
						<div class="location" style="line-height:30px;">
							<a href="pages/index.html">首页</a> - <a href="government">政策信息</a>
						</div>
						<h2>政策信息</h2>
								...
								<div id="post-249"
									...
									<h3>
										<span style="float:left;font-family:微软雅黑;font-size:15px"><a
											href="policeContext?policyId=<s:property value='policyId'/>"><s:property
													value="policyTitle" /> </a> </span>. <span style="float:right"><s:date
										name="policyDate" format="yyyy-MM-dd " />&nbsp;&nbsp;<a
											href="policeContext?policyId=<s:property value='policyId'/>"
											class="more">查看详细</a> </span>
									</h3>
								</div>
								<div class="clear"></div>
							</div>
						...
						<div class="page">
							<a href="government?currentPage=1">首页</a> <a
								href="government?currentPage=<s:property value='currentPage-1'/>">[上一页]</a>
							<a
								href="government?currentPage=<s:property value='currentPage'/>"><s:property
									value="currentPage" /> </a>
							<s:if test="currentPage <=total-1">
								<a
									href="government?currentPage=<s:property value='currentPage+1'/>"><s:property
										value="currentPage+1" /> </a>
							</s:if>
							<s:if test="currentPage <=total-2">
								<a
									href="government?currentPage=<s:property value='currentPage+2'/>"><s:property
										value="currentPage+2" /> </a>
							</s:if>
							<a
								href="government?currentPage=<s:property value='currentPage+1'/>">[下一页]</a>
							<a href="government?currentPage=<s:property value='total'/>">[尾页]</a>
						</div>
					</div>
					<div class="clear"></div>
				</div>

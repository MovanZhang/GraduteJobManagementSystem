				...
				<div class="col-sm-12">
					<div class="signin">
						<form class="form-signin" role="form"
							action="<%=request.getContextPath()%>/page/studentLogin.action"
							method="post">
							<input type="text" name="tbStudent.stuId" class="form-control"
								placeholder="学号/工号" required autofocus /> <input
								type="password" name="tbStudent.stuPwd" class="form-control"
								placeholder="密码" required /> <input type="text"
								name="chknumber" id="chknumber" maxlength="4"
							...
							<h3 align="right">
								<strong><a href="../pages/stuRegist.jsp">学生注册</a> </strong>
							</h3>
						</form>
					</div>
				</div>

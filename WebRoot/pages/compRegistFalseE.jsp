...
<body>
	...
	<form action="page/companyRegist" method="post">
		...
		</font> <font color="red" size="2">该用户名已被注册</font>
		<table width="400" border="1" bordercolor="#99CCFF" bgcolor="#FFFFEE"
			class="a">
			<tr>
				<td colspan="2" align="center">企业注册</td>
			</tr>

			<tr>
				<td width="100">帐号</td>
				<td><input type="text" name="tbCompany.compUsername" />
				</td>
			</tr>

			<tr>
				<td>单位名称</td>
				<td><input type="text" name="tbCompany.compName" />
				</td>
			</tr>
			...
			<tr>
				<td>登录密码</td>
				<td><input type="password" name="tbCompany.compPwd" />
				</td>
			</tr>
			<tr>
				<td>确认密码</td>

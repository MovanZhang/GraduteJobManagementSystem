...
#massage_box {
	...
	width: 775px;
	height: 486px;
	filter: dropshadow(color =     #666666, offx =     3, offy =     3, positive =
		    2);
	z-index: 2;
	visibility: hidden;
				...
				<div class="subbody" style="padding-top:31px;">
					<div class="subbodyleft">
						<ul>
							...
							<li><a
								href="policeContext?policyId=<s:property value='policyId'/>">详细信息</a>
							</li>
						</ul>
						...
						<div class="post" id="post-262">
							<h3>
								<span style="font-family:微软雅黑;float:left"><s:property
										value="tbp.policyTitle" />
								</span>. <span style="font-family:微软雅黑;float:right"> <s:date
										name="tbp.policyDate" format="yyyy-MM-dd " />
								</span>
							</h3>
							<br />
							<div class="newscontent">
								<div class="entry">
									<table frame="void" align="center" border=0
										...
										<tr>
											<td>${ tbp.policyCon} <!-- <s:generator val="tbp.policyCon"
													separator="<p>">
													<s:iterator>
														<p>
															&nbsp;&nbsp;&nbsp;&nbsp;

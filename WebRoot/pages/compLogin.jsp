				...
				<div class="col-sm-12">
					<div class="signin">
						<form class="form-signin" role="form"
							action="<%=request.getContextPath()%>/page/companyLogin.action"
							method="post">
							<input type="text" name="tbCompany.compUsername"
								class="form-control" placeholder="用户名" required autofocus /> <input
								type="password" name="tbCompany.compPwd" class="form-control"
							...
							<h3 align="right">
								<strong><a href="../pages/compRegist.jsp">企业注册</a>
								</strong>
							</h3>
						</form>
					</div>
